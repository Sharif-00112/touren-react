...
const Login = () => {
    ...
    return (
        <div>
            { !user.email ? <h2 className='text-success mt-5'>-User Login-</h2> 
            :
            <div className="">
            ...
            { !user.email ?
                <div className="">
                    ...
                    <p className='m-4'>Or, Sign Up Using</p>

                    <button onClick={signInUsingGoogle} className='btn btn-danger p-2 m-2'>Google</button>

                    <button onClick={signInUsingFacebook} className='btn btn-primary p-2 m-2'>Facebook</button>

                    <br />
                    <h5>{error}</h5>
                    <br /> 

                    <Link className='text-decoration-none text-white m-2' to="/register"><u><button className='btn btn-success p-2 m-3'>New User? Click to Register!</button></u></Link>
                </div>
                :
                <div className="mb-5">
